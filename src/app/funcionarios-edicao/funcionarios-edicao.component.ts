...
import { formatDate } from '@angular/common'; // biblioteca utilizada para formatação de datas
    ...
    this.httpClient.get(environment.apiUrl + "api/empresas")
      ...
      .subscribe(
        { next: (result: any) => {
          ...
          this.formEdicao.patchValue(result); // pegando os campos que vieram do "result" e preenchendo formulario
        ...
        this.formEdicao.controls['dataAdmissao']
          ...
          //tratamento para preenchimento do campo select que traz o 'nome da empresa' amarrado ao idEmpresa
          this.formEdicao.controls['idEmpresa']
          .setValue(result.empresa.idEmpresa);
        },
        error: (e) => {
          console.log(e);
        }
 ...
 formEdicao = new FormGroup({
  ...
  onSubmit(): void {
    ...
    this.httpClient.put(
      ...
      this.formEdicao.value, // mandando os campos do formulario que foram alterados para update na api/funcionarios
    { responseType: 'text' }
    )
    .subscribe(
      {
